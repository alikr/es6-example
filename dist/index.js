...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dmodule = __webpack_require__(118);

	var _dmodule2 = _interopRequireDefault(_dmodule);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	console.log(_module.add);

	console.log(_dmodule2.default);

	var a = 1;
	var b = 2;
	var c = 3;
	var _user$name = { "user": "lan", "name": "xw" };
	var user = _user$name.user;
	var name = _user$name.name;

	console.log(user, name);

	var _us$nm = { "us": "lan", "nm": "xw" };
	var _us$nm$us = _us$nm.us;
	var ua = _us$nm$us === undefined ? "xx" : _us$nm$us;
	var nm = _us$nm.nm;
	var _us = { "us": "lan" };
	var _us$us = _us.us;
	var us = _us$us === undefined ? "xx" : _us$us;
	var first = 1;
	var rest = [2, 3, 4, 5];
	// let { x, y, ...z } = { x: 1, y: 2, a: 3, b: 4 };//chrome还不能直接使用，babel可以转换

	var propKey = "name";
	var obj = (_obj = {}, (0, _defineProperty3.default)(_obj, propKey, true), (0, _defineProperty3.default)(_obj, 'a' + 'bc', 123), _obj);
	console.log(obj);

	[[1, 2], [3, 4]].map(function (_ref) {
	...
	function bar() {
		var func = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : fun;
	...
	var genFun = _regenerator2.default.mark(function genFun(x) {
		var y;
	...
	try {
		for (var _iterator2 = arr2.keys()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	...
	try {
		for (var _iterator3 = arr2.entries()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	...
	var promises = [3, 4].map(function (id) {
	...
	var promises2 = [5, 6].map(function (id) {
		return new Promise(function (resolve, reject) {
			setTimeout(function () {
				if (id == 6) {
	...
	var doAsync = function doAsync(x) {
		return new Promise(function (resolve, reject) {
			setTimeout(function () {
	...
	var classObj = function () {
		function classObj(x) {
			(0, _classCallCheck3.default)(this, classObj);

			this.x = x;
		}

		(0, _createClass3.default)(classObj, [{
			key: 'val',
			value: function val() {
				return this.x;
			}
	...
	classObj.view();
	var tObj = new classObj(1000);
	console.log(tObj.val());

	var extendObj = function (_classObj) {
		(0, _inherits3.default)(extendObj, _classObj);

		function extendObj(x, y) {
			(0, _classCallCheck3.default)(this, extendObj);

			var _this = (0, _possibleConstructorReturn3.default)(this, (extendObj.__proto__ || Object.getPrototypeOf(extendObj)).call(this, x));

			_this.y = y;
			return _this;
		}

		(0, _createClass3.default)(extendObj, [{
			key: 'values',
